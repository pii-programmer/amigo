...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できるとき' do
      ...
      it 'nicknameが30文字以下であれば登録できる' do
        @user.nickname = 'iamnickname'
        expect(@user).to be_valid
      end
    ...
    context '新規登録できないとき' do
      ...
      it 'nicknameは31文字以上では登録できない' do
        @user.nickname = 'kmnbvcsijbcdsertyuuyfdvbhgfwerg'
        @user.valid?
      ...
      it 'passwordとpassword_confirmationは5文字以下では登録できない' do
        @user.password = 'p0a0s'
        @user.password_confirmation = 'p0a0s'
        @user.valid?
